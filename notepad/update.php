            ...
            <div class="container">
                ...
                <div class="row tab-text">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control input-update" placeholder="改为什么呢" name="update"></td>
                        <td><button type="submit" class="btn btn-success" name="note-add" value="<?php echo $dbid ?>">修改</button></td>
                        </form>
                    ...
                    <?php 
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST"&&$_REQUEST["update"]!=null) {
                            $db_id=$_REQUEST["note-add"];
                            $db_note=$_REQUEST["update"];
                            $time=date('yy-m-d');//时间也要改变

                            //根据获取的ID修改
                            $det=$mysqli->query("update note set note ='$db_note',time='$time' where id ='$db_id';");
                            ?>
                            <script type="text/javascript"> 
                                //刷新页面
