        ...
        <section class="bg-top tab-center">
            <div class="container">
                ...
                <div class="row tab-text">
                    <h2>搜索</h2>
                    <div class="text-find">
                        <form  method="post" action="" name="find-form" enctype="multipart/form-data">
                        <input type="text" class="form-control input-find" placeholder="写点什么" name="find">
                        <button type="submit" class="btn btn-success" id="note-find">查找</button>
                        </form>
                    </div>
                    </div>
                    <div class="row tab-text">
                    ...
                    <?php 
                    $count=0;
                    if ($_SERVER["REQUEST_METHOD"] == "POST"&&$_REQUEST["find"]!=null) {//如果提交成功
                    ...
                    {//while循环将$result中的结果找出来
                        ...
                        $dbtime=$time;
                        $find=$_REQUEST["find"];
                        if(strstr($dbnote, $find)){//包含，就渲染
                            $count++;
                            ?>
                            <tr>
                                <td><?php echo $count;?></td>
                                <td><?php echo $dbnote;?></td>
                                <td><?php echo $dbtime;?></td>
                            </tr>
                            <?php 
